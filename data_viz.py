...
coach_colors = {
    "Felix Ott": "#C1D6FF",  # Subtle Blue
    "Pino Ott": "#FFD1B2",  # Subtle Orange
    "Ronny Kemmerich": "#B2FFD1",  # Subtle Green
    "Alex Grozdanovic": "#FFB2D6",  # Subtle Pink
    "Paul Sämann": "#D1B2FF",  # Subtle Purple
}
...
st.markdown(
    """
    <div style="background: linear-gradient(90deg, #3E4E78, #596888); padding: 20px; border-radius: 8px;">
        <h1 style="color: white; text-align: center; font-size: 36px; margin: 0;">🎾 Training Scheduler</h1>
        <p style="color: white; text-align: center; font-size: 18px; margin: 5px 0;">
            Manage your training sessions effortlessly with a clean and intuitive interface.
        </p>
    </div>
    """,
